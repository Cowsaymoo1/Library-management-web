...
router.post('/cancel-id-student-request', asyncHandler(controllerUser.cancelIdStudentRequest));
router.post('/update-student-card-status', asyncHandler(controllerUser.updateStudentCardStatus));
router.post('/remove-student-card', asyncHandler(controllerUser.removeStudentCard));
