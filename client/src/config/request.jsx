...
export const requestCancelIdStudentRequest = async (data) => {
    const res = await apiClient.post(`${apiUser}/cancel-id-student-request`, data);
    return res.data;
};

export const requestUpdateStudentCardStatus = async (data) => {
    const res = await apiClient.post(`${apiUser}/update-student-card-status`, data);
    return res.data;
};

export const requestRemoveStudentCard = async (data) => {
    const res = await apiClient.post(`${apiUser}/remove-student-card`, data);
    return res.data;
};
...
export const requestDeleteHistoryBook = async (data) => {
    const res = await apiClient.post(`${apiHistoryBook}/delete-history-book`, data);
    return res.data;
};
