...
function ModalBorrowBook({ visible, onCancel, bookData }) {
    ...
    useEffect(() => {
        if (visible && dataUser) {
            form.setFieldsValue({
                ...
                phoneNumber: dataUser?.phoneNumber || dataUser?.phone || '',
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            if (!bookId) {
                toast.error('Không tìm thấy ID sách hợp lệ!');
                return;
            }
    ...
    const isCardLocked = dataUser?.cardStatus === 'locked' && dataUser?.idStudent && dataUser?.idStudent !== '0';
                ...
                <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200">
                    ...
                    {isCardLocked && (
                        <Alert
                            ...
                            showIcon
                            className="mb-4"
                            message="Thẻ sinh viên đang bị tạm khóa"
                            description="Bạn chưa thể mượn sách. Vui lòng liên hệ quản trị viên để mở khóa thẻ."
                        />
                    )}
                    <Form form={form} layout="vertical" onFinish={handleSubmit} requiredMark={false} preserve={false}>
                        ...
                        <div className="flex justify-end space-x-3 pt-4">
                            ...
                            <Button
                                ...
                                disabled={isSubmitDisabled || isCardLocked}
                            >
